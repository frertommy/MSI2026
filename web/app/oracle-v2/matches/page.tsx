...
async function fetchOracleV2State(): Promise<Map<string, { index: number; b: number; m1: number }>> {
  ...
  if (error) { console.error("team_oracle_v2_state fetch error:", error.message); return map; }
...
export default async function MatchesV2Page() {
  ...
  return (
    <main className="mx-auto max-w-7xl px-6 py-6">
      <div className="flex items-center gap-3 mb-6">
        ...
        <span className="text-xs text-cyan-400 font-mono">Oracle V2</span>
